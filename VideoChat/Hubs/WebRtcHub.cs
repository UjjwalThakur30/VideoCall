...
namespace VideoChat.Hubs
{
    ...
    public class WebRtcHub : Hub
    {
        ...
        public void Join(string username,string type)
        {
            // Add the new user
            Users.Add(new User
            {
        ...
        public void SendNotification(string connectionId, string message)
        {
            var callingUser = Users.SingleOrDefault(u => u.ConnectionId == Context.ConnectionId);
            Clients.Client(connectionId).ReceiveNotification(message,callingUser);
        }
